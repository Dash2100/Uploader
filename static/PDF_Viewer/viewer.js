...
if (typeof window !== "undefined" && window["pdfjs-dist/build/pdf"]) {
  ...
  pdfjsLib = require("/static/PDF_Viewer/build/pdf.js");
}
...
const defaultOptions = {
  ...
  imageResourcesPath: {
    value: "/static/PDF_Viewer/images/",
    kind: OptionKind.VIEWER
  },
  maxCanvasPixels: {
    value: 16777216,
  ...
  cMapUrl: {
    value: "/static/PDF_Viewer/web/cmaps/",
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  standardFontDataUrl: {
    value: "/static/PDF_Viewer/web/standard_fonts/",
    kind: OptionKind.API
  },
  verbosity: {
    value: 1,
  ...
  workerSrc: {
    value: "/static/PDF_Viewer/build/pdf.worker.js",
    kind: OptionKind.WORKER
  }
};
{
  defaultOptions.defaultUrl = {
    value: "/static/PDF_Viewer/pdfs/test1.pdf",
    kind: OptionKind.VIEWER
  };
  ...
  defaultOptions.sandboxBundleSrc = {
    value: "/static/PDF_Viewer/build/pdf.sandbox.js",
    kind: OptionKind.VIEWER
  };
}
...
document.webL10n = function (window, document, undefined) {
  ...
  function parseResource(href, lang, successCallback, failureCallback) {
    var baseURL = href.replace(/[^\/]*$/, '') || '/static/PDF_Viewer/';
...
function getViewerConfiguration() {
  return {
    ...
    debuggerScriptPath: "/static/PDF_Viewer/debugger.js"
  };
}
